...
public class PaymentController {
    ...
    public void processPayment(String event) throws JsonMappingException, JsonProcessingException {
    	...
    	System.out.println("called --> 02-payment-service --> processPayment() method -->'new-orders' @KafkaListener");
        ...
        try {
        	...
        	System.out.println("called --> 02-payment-service --> catch() block -->'reversed-orders' @KafkaListener");
            payment.setOrderId(order.getOrderId());
